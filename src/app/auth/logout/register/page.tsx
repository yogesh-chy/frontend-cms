...
export default function LogoutRegisterPage() {
  ...
  const saveDuesData = (dues: any) => {
    if (typeof window !== "undefined") localStorage.setItem(DUES_KEY, JSON.stringify(dues));
  };
    ...
    <main className="auth-page register-theme">
      <div className="auth-card">
        ...
        <div className="auth-footer">
          <a href="/auth/logout/login" className="link">Already have an account? Login</a>
        </div>
      </div>
    </main>
  );
